                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="d-flex justify-content-center align-items-center">
                        ...
                        <a href="{{route('BU_project.edit',$item->id)}}" class="btn btn-sm btn-warning m-2">
                          <i class="fas fa-edit"></i>
                        </a>

                        <form  id="{{$item->id}}" action="{{route('BU_project.destroy',$item->id)}}"  class="formulario-eliminar" method="post">
                          @csrf
                          @method('DELETE')
