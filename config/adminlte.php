    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'List des projets',
                    'url'  => 'indexCat',
                    'icon' => 'fas fa-fw fa-list'        
                ],
               
                [
                    'text' => 'Projets valider',
                    'url'  => 'ProjetValider',
                    'icon' => 'fa fa-check'
                ],
                [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Les taches valider',
                    'url'  => '/TacheValider',
                    'icon' => 'fa fa-check'
                ],
                [
                    'text' => 'Les taches En cours',
                    'url'  => '/TacheEnCours',
                    'icon' => 'fa fa-spinner'
                ],
                [
                    'text' => 'Les taches Null',
                    'url'  => '/TacheNull',
                    'icon' => ' fa fa-hourglass-half'
                ],
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'List des Categories',
                    'url'  => '/categorie',
                    'icon' => 'fas fa-fw fa-list'
                ],
               
                [
                    'text' => 'Cree une Categorie',
        ...
        [
            'text'    => 'Rapport par jour',
            'url'     => '/Rapport_Par_Jours',
            'icon'    => 'fa fa-file-pdf',
           
        ],
        [
            'text'    => 'générer un rapport personne selon la période',
            'url'     => '/Rapport',
            'icon'    => 'fa fa-file-pdf',
